...
public int calculateInventoryLevel(String productCode) {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    String supplyFilePath = "C:\\Users\\venkatesh\\Desktop\\Assignments\\Day1\\app\\data\\supply_details.csv";
                    inventorySystem.loadSupplyDetailsFromCSV(supplyFilePath);
                    System.out.println("Supply details loaded successfully.");
                    break;
                case 2:
                    
                    String demandFilePath = "C:\\Users\\venkatesh\\Desktop\\Assignments\\Day1\\app\\data\\demand_details.csv";
