...
public class Food_Distribution_System {
    private static final String DATABASE_URL = "jdbc:sqlite:food_distribution_system.db";
...
//case 1
    ...
    private static void FoodDetailsAvailable() {
        try (Connection connection = DriverManager.getConnection(DATABASE_URL);
    ...
    private static void generateFoodRequest() {
        try (Connection connection = DriverManager.getConnection(DATABASE_URL);
